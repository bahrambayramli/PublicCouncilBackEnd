                    ...
                    <asp:GridView
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="deletePost" runat="server" OnClientClick="return confirm('Silməyə əminsiz?'); " OnClick="deletePost_Click" CausesValidation="False" CommandName="Delete" Text="Sil"></asp:LinkButton>
                                </ItemTemplate>
