        ...
        <ContentTemplate>
            ...
            <div class="row">
                <asp:ListView ID="POSTLIST_AZ" runat="server" OnPagePropertiesChanging="POSTLIST_AZ_PagePropertiesChanging">
                    <ItemTemplate>
                        <article class="col-12 d-flex align-items-stretch border-danger">
                            <a href="/site/details/az/<%#Eval("DATA_ID")%>" class="shadow p-2 mb-3 rounded d-block text-default h5 w-100 text-wrap" title="<%#Eval("POST_SEOAZ")%>"
                ...
                <asp:ListView ID="POSTLIST_EN" runat="server" OnPagePropertiesChanging="POSTLIST_EN_PagePropertiesChanging">
                    <ItemTemplate>
                        <article class="col-12 d-flex align-items-stretch border-danger">
                            <a href="/site/details/en/<%#Eval("DATA_ID")%>" class="shadow p-2 mb-3 rounded d-block text-default h5 w-100 text-wrap" title="<%#Eval("POST_SEOEN")%>"
                                style="border-left: 4px solid #32325d;">
                                <%#Eval("POST_SEOEN")%>
                            </a>
                        </article>
