...
namespace PublicCouncilBackEnd.subsite
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void POSTLIST_AZ_PagePropertiesChanging(object sender, PagePropertiesChangingEventArgs e)
        {
            ...
            try
            {
                GetPosts(Convert.ToString(Page.RouteData.Values["language"]).ToLower(), "legislation", false, true, Convert.ToString(Page.RouteData.Values["publicocuncil"]).ToLower(), POSTLIST_AZ, POSTLIST_EN);
            }
            catch (Exception ex)
            {
