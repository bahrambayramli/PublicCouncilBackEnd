                        ...
                        <ItemTemplate>
                            <div class="slider-item">
                                ...
                                <div class="slider-caption">
                                    ...
                                    <a class="caption-link" href="/<%#Eval("POST_AUTHOR")%>/details/az/<%#Eval("DATA_ID")%>" title="<%#Eval("POST_SEOAZ")%>"></a>
                                </div>
                            </div>
                        </ItemTemplate>
                    </asp:ListView>
                        ...
                        <ItemTemplate>
                            <div class="slider-item">
                                ...
                                <div class="slider-caption">
                                    ...
                                    <a class="caption-link" href="/<%#Eval("POST_AUTHOR")%>/details/en/<%#Eval("DATA_ID")%>" title="<%#Eval("POST_SEOEN")%>"></a>
                                </div>
                            </div>
                        </ItemTemplate>
                    </asp:ListView>
                ...
                <article class="col-12 col-md-6 d-flex align-items-stretch">
                    <div class="card mb-3 rounded post overflow-hidden">
                        <div class="post-header overflow-hidden">
                            <a href="/<%#Eval("POST_AUTHOR")%>/details/az/<%#Eval("DATA_ID")%>" class="d-block" title="">
        ...
        <asp:ListView ID="SIMPLEPOSTS_EN" runat="server">
            ...
            <ItemTemplate>
                <article class="col-12 col-md-6 d-flex align-items-stretch">
                    <div class="card mb-3 rounded post overflow-hidden">
                        <div class="post-header overflow-hidden">
                            <a href="/<%#Eval("POST_AUTHOR")%>/details/en/<%#Eval("DATA_ID")%>" class="d-block" title="">
