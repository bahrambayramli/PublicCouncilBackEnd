<%@ Page Title="" Language="C#" MasterPageFile="~/subsite/Subdomain.Master" AutoEventWireup="true" CodeBehind="publications.aspx.cs" Inherits="PublicCouncilBackEnd.subsite.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="sublayout" runat="server">
    <asp:UpdatePanel ID="POSTS_PANEL" runat="server" class="container-fluid">
        <ContentTemplate>
            <div class="row">
                <div class="col-12">
                    <asp:HyperLink ID="postsName" runat="server" CssClass="d-block text-white p-2 mb-2 bg-default rounded shadow-sm post-block-title text-center text-uppercase" Style="font-size: 2rem"></asp:HyperLink>
                </div>
            </div>
            <div class="row">
                        ...
                        <article class="col-12 col-md-6 col-xl-4 d-flex align-items-stretch">
                            ...
                            <div class="card mb-3 rounded post overflow-hidden">
                                ...
                                <div class="d-flex justify-content-between py-2 px-2">
                                    <a class="btn btn-sm btn-outline-default btn-round shadow-sm" href="/publications/az">
                    ...
                    <ItemTemplate>
                        <article class="col-12 col-md-6 col-xl-4 d-flex align-items-stretch">
                            ...
                            <div class="card mb-3 rounded post overflow-hidden">
                                ...
                                <div class="d-flex justify-content-between py-2 px-2">
                                    <a class="btn btn-sm btn-outline-default btn-round shadow-sm" href="/publications/en">
